...
- 桌面 / 行動端全平台閱讀
- EPUB、TXT、FB2/FBZ 閱讀（MOBI、AZW3、CBZ 為進階）
- 我的書架：匯入、封面、進度、搜尋篩選、閱讀狀態
- 翻頁 / 連續捲動、單頁 / 雙欄、寬度與排版調節
- 閱讀進度持久化、書籤、剩餘閱讀時間估算
- 段落閱讀模式、沉浸式全螢幕、參考閱讀點（進階）
- 書架書單（進階）
...
**EPUB、TXT、FB2/FBZ** 在基礎體驗中即可閱讀；**MOBI、AZW3、CBZ** 等需啟用進階支援。詳見上文 [基礎體驗與進階支援](#基礎體驗與進階支援)。
