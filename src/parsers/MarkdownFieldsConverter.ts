...
import { hasMetadataSection, splitContentAndMetadata } from "../constants/markdown-delimiters";
import type {
	CardMetadata,
	ParseError,
	ParseErrorType,
...
import { extractRelatedLinks, parseMetadataFields } from "./regex-patterns";
