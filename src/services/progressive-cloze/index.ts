...
export type {
	ICardStorageService,
	CardCreationOptions,
} from "./ProgressiveClozeCardManager";
...
/**
 * Compatibility note: 请使用 progressive-cloze-v2 中的类型
 */
export type {
	ClozeAnalysisResult,
...
// progressive-cloze-study.ts 已删除（V1.5废弃）
// 所有V1.5类型和函数已移除
...
/**
 * Compatibility note: 方案A的类型，已被V2替代
 */
export type {
	ClozeMap,
	ChildClozeMetadata,
