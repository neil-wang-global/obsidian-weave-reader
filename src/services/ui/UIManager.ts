 ...
 * UI组件类型
 */
export type UIComponentType = "floating-button" | "create-card-modal" | "global-modal";
...
type UIComponentMetadata = Record<string, unknown>;

interface UIComponent {
	type: UIComponentType;
	instance: UIComponentInstance | null;
