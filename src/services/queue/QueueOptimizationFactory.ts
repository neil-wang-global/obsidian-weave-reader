...
import type { QueueOptimizationSettings } from "../../types/queue-optimization-types";
...
export class QueueOptimizationFactory {
	 ...
	 * @returns 完整的队列优化系统实例
	 */
	static create(settings?: Partial<QueueOptimizationSettings>): QueueOptimizationSystem {
