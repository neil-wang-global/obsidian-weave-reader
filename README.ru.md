...
- Настройки вёрстки: по умолчанию следуют Obsidian; в читалке можно задать свой шрифт и размер основного текста
...
| **Типографика чтения**: **следовать Obsidian**, **свой шрифт и размер основного текста**, **оригинальные стили книги (издателя)** | ✅ | ✅ |
...
По умолчанию читалка **следует шрифту и размеру текста Obsidian**. Откройте **Типографику** в меню читалки и включите **Свой шрифт и размер основного текста**, чтобы выбрать пресет и настроить размер (в процентах от базы Obsidian). При включённом **Стилях издателя** используются оригинальные шрифты EPUB.
